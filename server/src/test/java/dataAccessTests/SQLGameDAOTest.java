...
public class SQLGameDAOTest {
    ...
    public void testDeleteAllGameData_Positive() throws DataAccessException, SQLException {
        int gameID1 = SQLGame.newGame("user1", "game1");
        int gameID2 = SQLGame.newGame("user2", "game2");
    ...
    public void testGetGames_Positive() throws DataAccessException, SQLException {
        SQLGame.newGame("user1", "game1");
        SQLGame.newGame("user2", "game2");
    ...
    public void testNewGame_Positive() throws DataAccessException, SQLException {
        ...
        int result = SQLGame.newGame(username, gameName);
    ...
    public void testNewGame_Negative() {
        ...
        assertThrows(SQLException.class, () -> SQLGame.newGame(username, gameName));
    }

    @Test
    public void testGetGameByID_Positive() throws SQLException, DataAccessException {
        int gameID = SQLGame.newGame("testuser", "Test Game");
