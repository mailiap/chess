...
//        // Simulate a scenario where the game name is already in use
//        String existingGameName = "Existing Game";
//        SQLGame.newGame(existingGameName);
//
//        // Act & Assert: Call the method with the existing game name
//        // Expect the method to return 0 as the game creation should fail
//        assertEquals(0, SQLGame.newGame(existingGameName));
//    }
//
//    @Test
